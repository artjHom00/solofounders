...
let { data: latestArticles } = useFetch<LatestArticlesResponse>(`/api/articles/latest?take=${defaultTake}&skip=${currentPage.value * defaultTake}`);
...
<template>
  <div class="content-wrapper" v-if="latestArticles">
